            ...
            <ul class="navbar-nav mb-2 mb-lg-0">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        ...
                        <li><a class="dropdown-item" href="/login/login.jsp" onclick="confirmLogout()" style="color: #020053">Log Out</a></li>
...
<script>
    function confirmLogout() {
        if (confirm("Bạn có chắc chắn muốn đăng xuất không?")) {
            // Nếu người dùng xác nhận đăng xuất, chuyển hướng đến trang logout
            window.location.href = "/logout"; // Thay đổi "/logout" thành URL của trang logout thực tế
        }
    }
